...
function conditionnee({ id, data }: NodeProps<NodeData>) {
    return (
        <div className="item-test-wrap">
            <div className="item-test conditionnee" data-id="36085">
                <div className="item-test-header"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                        fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                        className="feather feather-shuffle icon-item-test-header">
                ...
                <div className="item-test-footer">
                    <h4>Action Conditionnée</h4>
                </div>
            </div>
            <div className="item-test-btn-show-nested conditionnee showed"><svg xmlns="http://www.w3.org/2000/svg" width="24"
